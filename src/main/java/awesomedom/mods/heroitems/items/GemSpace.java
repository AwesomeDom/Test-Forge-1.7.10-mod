...
public class GemSpace extends Item implements IBauble {

    public GemSpace() {
    	setMaxStackSize(1);
        setCreativeTab(HeroItems.tabSuperMC);
        setUnlocalizedName(Dictionary.MOD_ID + ":" + Dictionary.GEM_SPACE);
    }
    ...
    {
        this.itemIcon = register.registerIcon(Dictionary.MOD_ID + ":" + Dictionary.GEM_SPACE);
    }
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		player.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 10, 100));
