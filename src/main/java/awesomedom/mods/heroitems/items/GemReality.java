...
public class GemReality  extends Item implements IBauble {

    
    public GemReality() {
    	setMaxStackSize(1);
        setCreativeTab(HeroItems.tabSuperMC);
        setUnlocalizedName(Dictionary.MOD_ID + ":" + Dictionary.GEM_REALITY);
	}
    ...
    {
        this.itemIcon = register.registerIcon(Dictionary.MOD_ID + ":" + Dictionary.GEM_REALITY);
    }
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		player.addPotionEffect(new PotionEffect(Potion.invisibility.id, 10, 100));
	}
