...
public class GemSoul extends Item implements IBauble {

    
    public GemSoul() {
    	setMaxStackSize(1);
        setCreativeTab(HeroItems.tabSuperMC);
        setUnlocalizedName(Dictionary.MOD_ID + ":" + Dictionary.GEM_SOUL);
	}
    ...
    {
        this.itemIcon = register.registerIcon(Dictionary.MOD_ID + ":" + Dictionary.GEM_SOUL);
    }
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		player.addPotionEffect(new PotionEffect(Potion.resistance.id, 10, 100));
	}
